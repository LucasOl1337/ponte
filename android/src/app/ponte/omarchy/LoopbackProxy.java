...
public final class LoopbackProxy implements Closeable {
    ...
    static final class Request {
        ...
        static Request read(InputStream input, String host, String origin) throws IOException {
            ...
            boolean apiGet = method.equals("GET") && (path.equals("/api/power") || path.matches("/api/(health|state|screenshot|stream|audio|terminals|textinput)") || path.matches("/api/audio/[A-Za-z0-9_-]{1,100}") || terminalItem);
