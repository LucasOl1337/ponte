...
As melhorias de tela e terminais estão na próxima alfa. Foram verificadas em navegador e testes isolados; a instalação desta revisão no Redmi ainda está pendente. Veja o [guia de tela e terminais](docs/screen-and-terminals.md).
